            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 signup">
                        ...
                        <p>The Smart Grid Current Flow Monitoring System is an innovative IT project that aims to transform household energy consumption monitoring 
                            and management. This technology delivers real-time insights into the 
                            flow of electricity from power stations to individual residences using modern monitoring technologies(IOT) and data analytics. </p>
                    </div>
                    <!-- /col-lg-6 -->
                    <div class="col-lg-6">
                        <h1>Sign Up</h1>
